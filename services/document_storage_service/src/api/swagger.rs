...
#[openapi(
    ...
    paths(
        ...
        // /documentation
        documentation::inbound::axum_router::availability::handler,
        documentation::inbound::axum_router::list_sites::handler,
        documentation::inbound::axum_router::create_site::handler,
        documentation::inbound::axum_router::get_site::handler,
        documentation::inbound::axum_router::patch_site::handler,
        documentation::inbound::axum_router::delete_site::handler,
        documentation::inbound::axum_router::custom_domain::handler,
        documentation::inbound::axum_router::nav::create_handler,
        documentation::inbound::axum_router::nav::patch_handler,
        documentation::inbound::axum_router::nav::move_handler,
        documentation::inbound::axum_router::nav::delete_handler,
        documentation::inbound::axum_router::publish::publish_handler,
        documentation::inbound::axum_router::publish::latest_build_handler,
    ),
    components(
        schemas(
            ...
            // Documentation
            documentation::domain::model::DocumentationAvailability,
            documentation::domain::model::DocumentationSite,
            documentation::domain::model::NavNode,
            documentation::domain::model::NavNodeKind,
            documentation::domain::model::NavTreeNode,
            documentation::domain::model::BuildStatus,
            documentation::domain::model::SiteBuild,
            documentation::inbound::axum_router::SiteResponse,
            documentation::inbound::axum_router::SiteDetailResponse,
            documentation::inbound::axum_router::list_sites::ListSitesResponse,
            documentation::inbound::axum_router::create_site::CreateSiteRequest,
            documentation::inbound::axum_router::patch_site::PatchSiteRequest,
            documentation::inbound::axum_router::delete_site::DeleteSiteResponse,
            documentation::inbound::axum_router::custom_domain::SetCustomDomainRequest,
            documentation::inbound::axum_router::nav::CreateNavNodeRequest,
            documentation::inbound::axum_router::nav::PatchNavNodeRequest,
            documentation::inbound::axum_router::nav::MoveNavNodeRequest,
            documentation::inbound::axum_router::nav::MoveNavNodeResponse,
            documentation::inbound::axum_router::nav::DeleteNavNodeResponse,
            documentation::inbound::axum_router::publish::LatestBuildResponse,
        ),
    ),
    tags(
