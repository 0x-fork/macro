...
pub(crate) async fn populate_properties(
    ...
    for item in items {
        let props = match item {
            ...
            // Channels, calls, and CRM companies are not in entity_properties.
            SoupItem::Channel(_) | SoupItem::Call(_) | SoupItem::CrmCompany(_) => None,
        };
        if let Some(props) = props {
            ...
            match item {
                ...
                SoupItem::Channel(_) | SoupItem::Call(_) | SoupItem::CrmCompany(_) => {}
            }
        }
    }
