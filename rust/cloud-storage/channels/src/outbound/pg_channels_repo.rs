...
use crate::domain::{
    models::{
        ...
        ChannelInfo, ChannelMessageFilters, ChannelMessageKind, ChannelMetadata,
        ChannelParticipant, ChannelType, CountedReaction, CreateChannelRequest, MessageAttachment,
