...
/// Location response data variants.
#[derive(Serialize, Deserialize, Debug, ToSchema)]
#[serde(rename_all = "camelCase")]
...
impl DocumentResponseMetadata {
    ...
    /// Creates document response metadata from document metadata.
    #[instrument]
...
/// Response type for create document.
...
/// Presigned URL for document parts.
