...
export type ReorderEntityFavoritesMutationVariables = Exact<{
  entities: Array<EntityRefInput> | EntityRefInput;
}>;


export type ReorderEntityFavoritesMutation = { reorderEntityFavorites: { results: Array<{ success: boolean, requested: { type: GraphqlEntityType, entityId: string }, entity: { type: GraphqlEntityType, entityId: string } | null, affectedEntities: Array<{ type: GraphqlEntityType, entityId: string }>, error: { code: GraphqlEntityMutationErrorCode, message: string } | null }> } };
...
export type GroupSoupMembershipQuery = { user: { id: string, groupSoup: { bins: Array<{ key: string, totalCount: number, nextCursor: string | null, items: Array<{ entityId: string }> }> } } };
...
export type GroupSoupQuery = { user: { id: string, groupSoup: { bins: Array<{ key: string, totalCount: number, nextCursor: string | null, items: Array<{ entityId: string, entityType: GraphqlSoupEntityType, frecencyScore: number, entity:
            | { __typename: 'GraphqlSoupCall', id: string, isFavorited: boolean, channelId: string, channelName: string | null, createdBy: string, customName: string | null, summary: string | null, startedAt: string, endedAt: string | null, durationMs: number | null, isActive: boolean, status: string, attended: boolean, entityType: GraphqlSoupEntityType, displayName: string | null, participants: Array<{ userId: string, joinedAt: string, leftAt: string | null }>, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
            ...
            | { __typename: 'GraphqlSoupChannel', id: string, isFavorited: boolean, channelType: string, ownerId: string, organizationId: string | null, createdAt: string, updatedAt: string, viewedAt: string | null, interactedAt: string | null, isParticipant: boolean, entityType: GraphqlSoupEntityType, displayName: string | null, channelName: string | null, channelTeamId: string | null, participants: Array<{ channelId: string, userId: string, role: string, joinedAt: string, leftAt: string | null }>, latestMessage: { messageId: string, channelId: string, threadId: string | null, senderId: string, content: string, createdAt: string, updatedAt: string, deletedAt: string | null, mentions: Array<string> } | null, latestNonThreadMessage: { messageId: string, channelId: string, threadId: string | null, senderId: string, content: string, createdAt: string, updatedAt: string, deletedAt: string | null, mentions: Array<string> } | null, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> }
            | { __typename: 'GraphqlSoupChannelMessage', id: string, isFavorited: boolean, channelId: string, senderId: string, content: string | null, createdAt: string, updatedAt: string, effectiveUpdatedAt: string, replyCount: number, entityType: GraphqlSoupEntityType, displayName: string | null, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> }
            | { __typename: 'GraphqlSoupChat', id: string, isFavorited: boolean, ownerId: string, projectId: string | null, isPersistent: boolean, createdAt: string, updatedAt: string, viewedAt: string | null, deletedAt: string | null, entityType: GraphqlSoupEntityType, displayName: string | null, chatName: string, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
                  | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
                  | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
                  | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
                  | { __typename: 'GraphqlLinkPropertyValue', urls: Array<string> }
                  ...
                  | { __typename: 'GraphqlStringPropertyValue', stringValue: string }
                 | null }>, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> }
            | { __typename: 'GraphqlSoupCrmCompany', id: string, isFavorited: boolean, description: string | null, emailSync: boolean, hidden: boolean, createdAt: string, updatedAt: string, viewedAt: string | null, domains: Array<string>, entityType: GraphqlSoupEntityType, displayName: string | null, crmTeamId: string, crmCompanyName: string | null, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
                  | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
                  | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
                  | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
                  | { __typename: 'GraphqlLinkPropertyValue', urls: Array<string> }
                  ...
                  | { __typename: 'GraphqlStringPropertyValue', stringValue: string }
                 | null }>, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> }
            | { __typename: 'GraphqlSoupDocument', id: string, isFavorited: boolean, ownerId: string, fileType: string | null, projectId: string | null, createdAt: string, updatedAt: string, viewedAt: string | null, deletedAt: string | null, entityType: GraphqlSoupEntityType, displayName: string | null, documentName: string, subType: { kind: string, isCompleted: boolean | null } | null, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
                  | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
                  | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
                  | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
                  | { __typename: 'GraphqlLinkPropertyValue', urls: Array<string> }
                  ...
                  | { __typename: 'GraphqlStringPropertyValue', stringValue: string }
                 | null }>, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> }
            | { __typename: 'GraphqlSoupEmailThread', id: string, isFavorited: boolean, providerId: string | null, ownerId: string, inboxVisible: boolean, linkId: string | null, snippet: string | null, senderEmail: string | null, senderName: string | null, senderPhotoUrl: string | null, isRead: boolean, isDraft: boolean, isImportant: boolean, projectId: string | null, sortTs: string, createdAt: string, updatedAt: string, viewedAt: string | null, entityType: GraphqlSoupEntityType, displayName: string | null, emailName: string | null, participants: Array<{ id: string, linkId: string, name: string | null, email: string | null, sfsPhotoUrl: string | null }>, attachments: Array<{ id: string, messageId: string, providerAttachmentId: string | null, filename: string | null, mimeType: string | null, sizeBytes: number | null, contentId: string | null, createdAt: string }>, labels: Array<{ id: string, linkId: string, providerLabelId: string, name: string, createdAt: string, messageListVisibility: string, labelListVisibility: string, type: string }>, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
                  | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
                  | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
                  | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
                  | { __typename: 'GraphqlLinkPropertyValue', urls: Array<string> }
            ...
            | { __typename: 'GraphqlSoupForeignEntity', id: string, isFavorited: boolean, foreignEntityId: string, foreignEntitySource: string, storedForId: string, storedForAuthEntity: string, sourceMetadata: unknown, createdAt: string, updatedAt: string, entityType: GraphqlSoupEntityType, displayName: string | null, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> }
            | { __typename: 'GraphqlSoupProject', id: string, isFavorited: boolean, ownerId: string, parentId: string | null, createdAt: string, updatedAt: string, viewedAt: string | null, deletedAt: string | null, entityType: GraphqlSoupEntityType, displayName: string | null, projectName: string, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
                  | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
                  | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
                  | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
                  | { __typename: 'GraphqlLinkPropertyValue', urls: Array<string> }
...
export type QuickAccessSoupItemFieldsFragment = { entityId: string, entityType: GraphqlSoupEntityType, frecencyScore: number, entity:
    ...
    | { __typename: 'GraphqlSoupChannelMessage', id: string, channelId: string, senderId: string, content: string | null, createdAt: string, updatedAt: string, effectiveUpdatedAt: string, replyCount: number, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> }
    ...
    | { __typename: 'GraphqlSoupForeignEntity', id: string, foreignEntityId: string, foreignEntitySource: string, storedForId: string, storedForAuthEntity: string, sourceMetadata: unknown, createdAt: string, updatedAt: string, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> }
...
export type SoupQuery = { user: { id: string, soup: { nextCursor: string | null, hasMore: boolean, items: Array<{ entityId: string, entityType: GraphqlSoupEntityType, frecencyScore: number, entity:
          | { __typename: 'GraphqlSoupCall', id: string, isFavorited: boolean, channelId: string, channelName: string | null, createdBy: string, customName: string | null, summary: string | null, startedAt: string, endedAt: string | null, durationMs: number | null, isActive: boolean, status: string, attended: boolean, entityType: GraphqlSoupEntityType, displayName: string | null, participants: Array<{ userId: string, joinedAt: string, leftAt: string | null }>, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
                | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
                | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
                | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
...
export type SoupItemFieldsFragment = { entityId: string, entityType: GraphqlSoupEntityType, frecencyScore: number, entity:
    | { __typename: 'GraphqlSoupCall', id: string, isFavorited: boolean, channelId: string, channelName: string | null, createdBy: string, customName: string | null, summary: string | null, startedAt: string, endedAt: string | null, durationMs: number | null, isActive: boolean, status: string, attended: boolean, entityType: GraphqlSoupEntityType, displayName: string | null, participants: Array<{ userId: string, joinedAt: string, leftAt: string | null }>, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
          | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
          | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
          | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
...
type SoupEntityCoreFields_GraphqlSoupCall_Fragment = { id: string, entityType: GraphqlSoupEntityType, displayName: string | null };

type SoupEntityCoreFields_GraphqlSoupChannel_Fragment = { id: string, entityType: GraphqlSoupEntityType, displayName: string | null };

type SoupEntityCoreFields_GraphqlSoupChannelMessage_Fragment = { id: string, entityType: GraphqlSoupEntityType, displayName: string | null };

type SoupEntityCoreFields_GraphqlSoupChat_Fragment = { id: string, entityType: GraphqlSoupEntityType, displayName: string | null };

type SoupEntityCoreFields_GraphqlSoupCrmCompany_Fragment = { id: string, entityType: GraphqlSoupEntityType, displayName: string | null };

type SoupEntityCoreFields_GraphqlSoupDocument_Fragment = { id: string, entityType: GraphqlSoupEntityType, displayName: string | null };

type SoupEntityCoreFields_GraphqlSoupEmailThread_Fragment = { id: string, entityType: GraphqlSoupEntityType, displayName: string | null };

type SoupEntityCoreFields_GraphqlSoupForeignEntity_Fragment = { id: string, entityType: GraphqlSoupEntityType, displayName: string | null };

type SoupEntityCoreFields_GraphqlSoupProject_Fragment = { id: string, entityType: GraphqlSoupEntityType, displayName: string | null };
...
export const ReorderEntityFavoritesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReorderEntityFavorites"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"entities"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"EntityRefInput"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reorderEntityFavorites"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"entities"},"value":{"kind":"Variable","name":{"kind":"Name","value":"entities"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"EntityMutationPayloadFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"EntityMutationRefFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"GraphqlEntityMutationRef"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"entityId"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"EntityMutationResultFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"GraphqlEntityMutationResult"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}},{"kind":"Field","name":{"kind":"Name","value":"requested"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"entityId"}}]}},{"kind":"Field","name":{"kind":"Name","value":"entity"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"EntityMutationRefFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"affectedEntities"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"EntityMutationRefFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"error"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"EntityMutationPayloadFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"EntityMutationPayload"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"EntityMutationResultFields"}}]}}]}}]} as unknown as DocumentNode<ReorderEntityFavoritesMutation, ReorderEntityFavoritesMutationVariables>;
