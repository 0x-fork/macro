...
import {
  ...
  mergeAst,
  NIL_UUID,
} from '@app/features/next-soup/filters/facet-store';
import {
  EMAIL_INBOX,
  type FacetCtx,
} from '@app/features/next-soup/filters/facets';
import type { SetPredicatesInput } from '@app/features/next-soup/filters/filter-store/predicates-store';
import type { Query } from '@app/features/next-soup/filters/filter-store/query-store';
import {
  getViewPreset,
  type PresetContext,
