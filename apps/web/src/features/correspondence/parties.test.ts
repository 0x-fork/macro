...
import { addressDomain, externalParties, partyDomains } from './parties';
...
describe('partyDomains', () => {
  it('returns distinct domains in first-seen order', () => {
    expect(
      partyDomains([
        { email: 'jane@acme.com' },
        { email: 'bo@globex.com' },
