...
export type FacetCtx = { userId: string; assignees?: string[] };
...
export const selectProp = (definitionId: string, value: string): OptionClause => ({
  propf: eq('properties', { propertyId: definitionId, type: 'select', value }),
});
export const entityProp = (definitionId: string, value: string): OptionClause => ({
