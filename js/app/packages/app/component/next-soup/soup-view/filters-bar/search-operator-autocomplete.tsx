  ...
  return (
    <Show when={filteredOptions().length > 0}>
      <div
        ...
        class="absolute left-0 top-full mt-1 z-action-menu bg-surface border border-edge-muted rounded-sm shadow-md min-w-50 max-w-[320px] max-h-60 overflow-y-auto p-1"
