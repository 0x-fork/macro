...
const variantStyles: Record<SearchbarVariant, string> = {
  filled:
    'bg-ink/10 text-ink-muted hover:bg-ink/15 hover:text-ink border-transparent focus-within:bg-ink/15 focus-within:text-ink',
  secondary:
...
export const SoupSearchbar = (props: SoupSearchbarProps) => {
  ...
  return (
    ...
    >
      <div
        class={cn(
          'w-full relative flex items-center gap-1 rounded-md py-1.5 mobile:h-9 pl-2 pr-1 mobile:min-w-35 border text-xs shadow-inset-bevel',
