...
import { useInfiniteQuery, type UseQueryResult } from '@tanstack/solid-query';
...
export const createEntitiesQuery = (
  args: Accessor<{
  ...
  const query = useInfiniteQuery(() => ({
    ...
    select: (data) => {
      ...
      return data.pages.flatMap((page) => {
        ...
        return mapDssQueryPage(page, { instructionsIdQuery });
      });
    },
    enabled: enabled(),
  }));
