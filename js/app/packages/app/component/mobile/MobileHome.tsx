...
import MicrophoneSlashIcon from '@icon/microphone-slash.svg';
import VideoCameraIcon from '@icon/video-camera.svg';
import VideoCameraSlashIcon from '@icon/video-camera-slash.svg';
import PhoneDisconnectIcon from '@icon/phone-disconnect.svg';
