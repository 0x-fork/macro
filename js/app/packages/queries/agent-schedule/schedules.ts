...
export function useCreateScheduleMutation(
  ...
  return useMutation(() => ({
    mutationFn: async (request: CreateScheduledAction) =>
      throwOnErr(async () => await scheduledActionClient.createSchedule(request)),
    ...withCallbacks(
      {
...
export function useUpdateScheduleMutation(
  ...
  return useMutation(() => ({
    mutationFn: async (args: {
      ...
      throwOnErr(
        async () => await scheduledActionClient.updateSchedule(args)
      ),
    ...withCallbacks(
      {
        onSuccess: async (schedule) => {
...
export function useRunScheduleNowMutation(
  ...
  return useMutation(() => ({
    mutationFn: async ({ scheduleId }: { scheduleId: string }) =>
      throwOnErr(async () => await scheduledActionClient.runNow({ scheduleId })),
