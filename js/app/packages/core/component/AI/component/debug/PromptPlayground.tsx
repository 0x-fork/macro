...
export default function PromptPlayground() {
  ...
  const [promptEditor, setPromptEditor] = createSignal<
  ...
  return (
    <div class="relative flex flex-col w-full h-full">
      ...
      >
            ...
            <Show
              ...
              fallback={
                <div class="p-3 text-white font-mono text-sm bg-red-700">
                  Prompt Playground is mounted, but you are not authenticated
                  (chat UI hidden).
                </div>
              }
            >
        ...
        <Resize.Panel id="prompt-playground-prompt" minSize={360} maxSize={900}>
