...
export function AutomationPromptEditor(props: {
	...
	return (
		<div class="min-h-[180px] border border-edge-muted bg-input [&_[contenteditable]]:px-2 [&_[contenteditable]]:py-1.5 [&_[contenteditable]]:text-sm [&_[contenteditable]]:outline-none cursor-default">
			<MarkdownShell
				config={editor}
