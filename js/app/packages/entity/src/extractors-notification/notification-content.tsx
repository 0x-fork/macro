    ...
    <div class="relative pt-1">
      ...
      >
        ...
        <button
          ref={badgeRef}
          data-badge
          class="text-xs text-ink-muted border border-ink/10 rounded px-2 py-1 shrink-0"
          tabIndex={-1}
        >
      ...
      >
        ...
        <Show when={overflow() > 0}>
          <button
            class="text-xs text-ink-muted border border-ink/10 bg-ink/[0.03] hover:bg-ink/5 rounded px-2 py-1 shrink-0"
            onClick={(e) => {
              e.stopPropagation();
              setExpanded(true);
            }}
