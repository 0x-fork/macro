...
function placementStyle(
  ...
  return match(placement)
    .with('icon', () => ({ 'grid-area': 'icon' as const }))
    .with('header', () => ({ 'grid-area': 'header' as const }))
    .with('content', () => ({ 'grid-area': 'content' as const }))
    .with('footer', () => ({ 'grid-area': 'footer' as const }))
    .with('actions', () => ({ 'grid-area': 'actions' as const }))
    .exhaustive();
}
