      ...
      <Show when={!isNarrow()}>
        ...
        >
          <Layer depth={3}>
            <div
              class={cn(
                'h-full w-full bg-surface rounded-lg overflow-hidden transition-transform duration-200 ease-out ring-1 ring-edge-muted shadow-md',
        ...
        <Portal mount={props.containerRef()}>
          ...
          >
            ...
            <Layer depth={3}>
              <div
                class={cn(
                  'absolute inset-0 bg-surface transition-transform duration-200 ease-out ring-1 ring-edge-muted shadow-md',
                  isOpen() ? 'translate-x-0' : 'translate-x-full'
                )}
              >
                <DrawerContent channelId={props.channelId} onClose={drawerControl.close} />
